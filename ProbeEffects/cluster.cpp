...
void cuttreebydistance (int nelements, Node* tree, double distance, int clusterid[]) 
/*
 Purpose
 =======
 
 Use the distance between groups of clusters to choose the number of clusters.  
 */
{
	int nclusters = 1; /* number of nodes to join */
	int i;	
	...
	// will there be a problem if nclusters == 1?  
	// will there be a problem if nclusters == nelements?  
	cuttree( nelements, tree, nclusters, clusterid );
	return;
