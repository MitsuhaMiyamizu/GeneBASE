...
CBPMAPFileData2::CBPMAPFileData2() :
	m_NumberSequences(0),
	m_bFileOpen(false),
	m_lpFileMap(NULL),
	m_lpData(NULL),
...
bool CBPMAPFileData2::ReadHeader()
{
...
bool CBPMAPFileData2::ReadFile(bool bReadHeaderOnly)
{
...
bool CBPMAPFileData2::ReadHeaderSection()
{
	// Open the file.
	std::ifstream instr;
...
bool CBPMAPFileData2::ReadDataSection()
{
	// Open the file.
	std::ifstream instr;
	instr.open(m_FileName.c_str(), std::ios::in | std::ios::binary);
...
void CBPMAPFileData2::GetSequenceItem(int index, CGDACSequenceItem &seq)
{
